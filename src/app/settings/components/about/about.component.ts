    ...
    protected readonly versionHistory = [
        {
            ...
            date: 'Декабрь 2025',
            changes: [
                'Умная синхронизация: интеллектуальное слияние данных (Smart Merge)',
                'Разрешение конфликтов: стратегия "последнее изменение побеждает"',
                'Авто-выгрузка: сохранение данных в облако при закрытии приложения',
                'Безопасное удаление: синхронизация удалений через корзину (Soft Delete)',
                'Полная поддержка новых модулей счетчиков и подписок в облаке',
                'Исправлено сохранение мастер-пароля'
            ]
        },
        {
            version: 'v1.0.0',
            ...
            changes: [
                ...
                'Выбор валюты для каждого долга',
